...
const ADDONS = [
    ...
    },
    {
        ...
        emoji: '🔊',
        name: 'Text-to-Speech',
        desc: 'Aparece un botón 🔊 en el lector EPUB. Pulsa para escuchar la página actual en voz alta.',
    ...
    },
    {
        ...
        emoji: '🍅',
        name: 'Pomodoro',
        desc: 'Activa el temporizador Pomodoro (25 min trabajo / 5 min descanso) al abrir un libro.',
    ...
    },
    {
        ...
        emoji: '🔍',
        name: 'X-Ray',
        desc: 'Panel lateral con personajes, lugares y términos del libro. Selecciona texto para añadir.',
        category: 'Lectura',
        context: 'reader',
        status: 'soon',
    },
    {
        ...
        emoji: '💬',
        name: 'Citas con IA',
        desc: 'La IA detecta frases destacables y te propone guardarlas como subrayados.',
        category: 'IA',
        context: 'reader',
        status: 'soon',
    },
    {
        id: 'cloudSync',
        emoji: '☁️',
        name: 'Sync en la Nube',
        desc: 'Sincroniza tu progreso, notas y marcadores entre dispositivos.',
        category: 'Datos',
        context: 'global',
        status: 'soon',
    },
...
const CATEGORIES = ['Todos', 'Lectura', 'Accesibilidad', 'Interfaz', 'Estadísticas', 'Productividad', 'IA', 'Datos', 'Navegación'];
